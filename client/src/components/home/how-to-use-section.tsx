...
import { Monitor, Globe, Sparkles, Download, ArrowRight, Play, Database, Cpu, Zap } from "lucide-react";
    ...
    <section id="how-it-works" className="py-20 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          {steps.map((step, index) => (
            ...
            >
              <div className="cyber-blur rounded-xl p-6 border border-white/10 h-full flex flex-col items-center text-center transform transition-all duration-300 hover:-translate-y-2 hover:border-primary/30 relative overflow-hidden">
                ...
                {/* Number + Icon */}
                <div className={`relative w-16 h-16 flex items-center justify-center rounded-full bg-gradient-to-br ${step.color} text-white mb-5 z-10 shadow-lg border border-white/20 glow-border hover-lift group-hover:scale-110 transition-transform`}>
                ...
                {/* Text content */}
                <h3 className="font-heading font-semibold text-xl mb-3 text-white group-hover:text-primary transition-colors">
                  {step.title}
                </h3>
        ...
        <div className="relative">
          ...
          <div className="absolute -bottom-20 right-20 opacity-10 floating" style={{ animationDelay: "-3s" }}>
