    ...
    <div className="flex-grow py-12 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="relative">
          {/* Decorative elements */}
          <div className="absolute -top-10 -left-10 floating opacity-70" style={{ animationDelay: "-1.5s" }}>
            <BrainAiIllustration width={80} height={80} />
          </div>
          <div className="absolute -bottom-10 -right-10 floating opacity-70" style={{ animationDelay: "-3s" }}>
            <BrainAiIllustration width={80} height={80} />
          </div>
