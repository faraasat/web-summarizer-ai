      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          <div className="md:w-1/2 space-y-8">
            ...
            <div
              className="absolute left-1/2 -translate-x-1/2 top-10 floating"
            ...
            <p className="font-body text-lg text-gray-300 md:pr-12">
              ...
              time and extract the key information you need without having to
              read everything.
            </p>
            <div className="pt-6 flex flex-col sm:flex-row gap-4">
              <Link
                href="/summarizer"
                className="inline-flex items-center justify-center px-8 py-4 border border-transparent text-base font-medium rounded-md shadow-lg text-white gradient-animation hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary transition-all glow-border"
              >
            ...
            <div className="relative cyber-blur rounded-2xl p-8 border border-white/10 glow-border">
              ...
              <div className="relative z-10 flex items-center justify-center">
                <BrainAiIllustration
                  width={300}
                  height={300}
                  className="relative z-20 floating"
                />
                <VirtualWorldIllustration
                  width={300}
                  height={300}
                  className="absolute opacity-20 z-12 scale-150"
                />
              </div>

              {/* UI Elements */}
              <div className="z-10 absolute top-6 right-6 px-4 py-2 cyber-blur rounded-full text-xs text-white/80 border border-white/10">
                AI-Powered
              </div>
              <div className="z-10 absolute bottom-4 left-6 right-6 cyber-blur rounded-lg p-3 border border-white/10">
                <div className="h-1 w-full bg-primary/50 rounded-full progress-bar"></div>
                <div className="mt-2 text-xs text-center text-white/70 font-body pulse-text">
